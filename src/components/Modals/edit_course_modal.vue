        ...
        <form>
          ...
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            ...
            <div class>
              <div class="flex flex-wrap gap-x-4 justify-center">
                ...
                <div
                  class="flex items-center space-x-6 my-5 mb-4 w-full md:w-5/12"
                >
              ...
              <div class="flex flex-wrap gap-x-4 justify-center">
                ...
                <div class="w-full md:w-5/12 mb-4">
                  ...
                  >
                    ...
                    <option value="1,4">Mon-Thu</option>
          ...
          <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            <button
              ...
              type="button"
              class="inline-flex justify-center w-full border border-green-500 bg-green-500 hover:bg-green-600 text-white rounded-md px-4 py-2 m-2 transition duration-500 ease select-none  focus:outline-none focus:shadow-outline"
            >
              <svg
